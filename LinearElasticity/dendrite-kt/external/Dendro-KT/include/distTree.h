...
namespace ot
{
  ...
  class DistTree
  {
    public:
      ...
      static void
      distRemeshSubdomainViaWhole(const DistTree &inTree, const std::vector<OCT_FLAGS::Refine> &refnFlags,
                                  DistTree &_outTree,
                                  DistTree &_surrogateTree, RemeshPartition remeshPartition, double loadFlexibility);
