...
//    DA *getForceRefineSubDA_InByOut(DistTREE &oldDistTree, const double sfcTol);

    DA *getForceRefineSubDA(DistTREE &oldDistTree, const double sfcTol, ot::RemeshPartition partition);

    DA *getRefineSubDASingleLevel(DistTREE &oldDistTree, const double sfcTol, const RefinementStrategy strategy,
                                  ot::RemeshPartition partition);


    DA *getRefineSubDA(DistTREE &oldDistTree, const double sfcTol, ot::RemeshPartition partition);
};
