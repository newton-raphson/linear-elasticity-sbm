...
DA *Refinement::getForceRefineSubDA(DistTREE &oldDistTree, const double sfcTol, ot::RemeshPartition partition) {
    std::fill(refineFlags_.begin(), refineFlags_.end(), ot::OCT_FLAGS::Refine::OCT_NO_CHANGE);
    DistTREE::distRemeshSubdomainViaWhole(oldDistTree, refineFlags_, newDistTree_, surrDistTree_, partition,sfcTol);
...
DA *Refinement::getRefineSubDA(DistTREE &oldDistTree,const double sfcTol, ot::RemeshPartition partition) {
        return getRefineSubDASingleLevel(oldDistTree,sfcTol,FULL_DOMAIN,partition);
