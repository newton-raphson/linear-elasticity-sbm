...
ht_res = [r for r in res if "ht" in r[1]]
...
if len(sys.argv) == 2 and sys.argv[1] == "all":
  ...
  ht_res = [r for r in res if "ht" in r[1] and os.path.dirname(r[0]) == startpath]
...
write_visit_file("visit_ht.visit", ht_res)
write_geom_file("visit_geo.visit", geom)

write_pvd_file("paraview_ns.pvd", ns_res)
write_pvd_file("paraview_ht.pvd", ht_res)
